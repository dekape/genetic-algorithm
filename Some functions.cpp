...
//Optimisation part
//Optimized function in case of dividing the pairing and generating apart.
//After calculating fitness each iterations.(Add it in main)
...
//Change it in GA.cpp
void pairParents(int ** circuits, int * parentA, int * parentB, int no_units, int no_circuits, double* fitness, double totalFitness)
{
	int index1 = -1; //index for parentA
	int index2 = -1; //index for parentB
